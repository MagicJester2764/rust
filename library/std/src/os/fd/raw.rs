...
#[cfg(any(target_os = "motor", target_os = "quark"))]
...
#[cfg(all(not(target_os = "hermit"), not(target_os = "motor"), not(target_os = "quark")))]
use crate::os::raw;
...
#[stable(feature = "rust1", since = "1.0.0")]
#[cfg(any(target_os = "hermit", target_os = "motor", target_os = "quark"))]
pub type RawFd = i32;
